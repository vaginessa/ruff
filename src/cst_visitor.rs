...
pub trait CSTVisitor {
    fn visit_Module<'a>(&mut self, node: Module<'a>) -> Module<'a>
    {
        walk_Module(self, node)
    }
    fn visit_Statement<'a>(&mut self, node: Statement<'a>) -> Option<Statement<'a>>
    {
    ...
    fn visit_AnnAssign<'a>(&mut self, node: AnnAssign<'a>) -> AnnAssign<'a>
    {
    ...
    fn visit_BinaryOp<'a>(&mut self, node: BinaryOp<'a>) -> BinaryOp<'a>
    {
...
pub fn walk_AnnAssign<'a, V: CSTVisitor + ?Sized>(
    visitor: & mut V,
    node: AnnAssign<'a>,
) -> AnnAssign<'a>
{
...
pub fn walk_BinaryOp<'a, V: CSTVisitor + ?Sized>(visitor: & mut V, node: BinaryOp<'a>) -> BinaryOp<'a> {
    // Nothing to do.
    node.clone()
}
